<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_excluir = "DELETE FROM conteiners WHERE id_registro_conteiner = '$id'";
...
<body>
    ...
    <main class="container mt-5">
        <div class=" card ">
            <h5 class="card-header">Confirmar exclusão de registro do contêiner</h5>
            <div class="card-body">
                <h5 class="card-title">Tem certeza que deseja excluir esse registro?</h5>
                <p class="card-text">Excluíndo esse resgitro você também irá remover todas as movimentações relacionadas.</p>
